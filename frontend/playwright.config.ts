...
export default defineConfig({
  ...
  webServer: [
    ...
    { command: "npm run dev -- --hostname 127.0.0.1 --port 3100", url: "http://127.0.0.1:3100/candidate", env: { PLAYWRIGHT_TEST: "true", API_BASE: "http://127.0.0.1:8010" }, reuseExistingServer: false, timeout: 120000 },
  ],
});
